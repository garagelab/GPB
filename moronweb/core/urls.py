...
from moronweb.core import feeds
...
urlpatterns = patterns('',
                       url(r'^$',
                           'moronweb.core.views.index',
                           {'start_date': datetime(datetime.now().year, 1, 1),
                            'end_date': datetime(datetime.now().year, 12, 31) },
                           name='index'),

                       url(r'^%s$' % mensual_expression,
                           'moronweb.core.views.index_mensual',
                           name='index_mensual'),

                       url(r'^%s$' % anual_expression,
                           'moronweb.core.views.index_anual',
                           name='index_anual'),

                       url(r'^%s$' % periodo_expression,
                           'moronweb.core.views.index_periodo',
                           name='index_periodo'),

                       url(r'^ordenes-de-compra/$',
                           'moronweb.core.views.index_ordenes',
                           {'start_date': datetime(datetime.now().year, 1, 1),
                            'end_date': datetime(datetime.now().year, 12, 31) },
                           name='index_ordenes'),
